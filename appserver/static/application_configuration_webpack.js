        ...
        i = [n(2), n(1), n(3), n(4), n(5), n(10)], a = function(e, t, i, a, o, s) {
            return t.fullExtend({
                ...
                _submit_authorize_form: function(e, t) {
                    ...
                    var u = this;
                    if ("undefined" == typeof c || c.length < 1) d.authtoken = "", console.log("No Auth Token");
                    else {
                        if (d.step = "two", c.length < 1) return void i("#" + o).html("Must provide Auth Token");
                        d.authtoken = c, d.flow_tmp = u.flow_tmp
                    }
                    this._service.get("/services/gmail_authorize", d).done(function(e) {
                        ...
                        "launch_url" === n.step ? (window.open(n.url, "_blank"), u.flow_tmp = n.flow_tmp, i("#authorize_search_btn .btn").html("Authorize Step 2"), i("#auth_token_div").show()) : "end_of_discussion" === n.step ? console.log(n) : (i("#auth_token_div").hide(), i("#authorize_search_btn .btn").html("Done")), i("#" + o).html(n.msg)
                    })
                }
            })
        }.apply(t, i), !(void 0 !== a && (e.exports = a))
