...
import input_module_gmail_enforce_audit as input_module
...
'''
    ...
    Add your modular input logic to file input_module_gmail_enforce_audit.py
'''
class ModInputgmail_enforce_audit(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputgmail_enforce_audit, self).__init__("ta_gmail_audit", "gmail_enforce_audit", use_single_instance)
...
if __name__ == "__main__":
    exitcode = ModInputgmail_enforce_audit().run(sys.argv)
    sys.exit(exitcode)
